...
class VersioningManager(object):
    ...
    :param unit_of_work_cls:
        ...
        versioning
    :param audit_cls:
        Audit class to use for versioning. If None, the default
        Audit class generated by AuditFactory will be used.
    :param user_cls:
        User class which Audit class should have relationship to. This
    ...
    def create_audit_model(self):
        """
        Create Audit class but only if it doesn't already exist in
        declarative model registry.
        """
        if isinstance(self.audit_cls, AuditFactory):
            self.audit_cls = self.audit_cls(self)
        return self.audit_cls
    ...
    def clear(self, session):
        ...
        audit commit or when audit rollback occurs. The purpose of
